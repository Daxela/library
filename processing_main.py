...
def add_book() -> None:
    ...
    current_book_title: str = input()
    print('Введите автора книги: ')
    current_book_author: str = input()
    print('Введите год издания книги (только число): ')
    current_book_year: str or int = input()
    if current_book_year.isdigit():
        current_book_year = int(current_book_year)
    current_book: Book = Book(current_book_title, current_book_author, current_book_year)
    errors: set[str] = current_book.check()
    if errors:
...
def delete_book() -> None:
    ...
    current_book_id: str or int = input()
...
def search_books() -> None:
    global current_books
    print('Для поиска книги введите информацию о ней. Если информация Вам не известна - пропустите шаг, нажав клавишу '
...
def receiving_issuing_book() -> None:
    global current_books
    ...
    current_book_status: str = input()
    flag: bool or None = current_books.receiving_issuing_book(current_book_id, current_book_status)
